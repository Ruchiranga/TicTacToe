 ...
 * @author ruchiranga
 */
public class TwoPlayer extends javax.swing.JDialog {

    /**
     * Creates new form TwoPlayer
     */
    public TwoPlayer(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                TwoPlayer dialog = new TwoPlayer(new javax.swing.JFrame(), true);
