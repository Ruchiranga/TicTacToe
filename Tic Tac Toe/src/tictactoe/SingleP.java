 ...
 * @author ruchiranga
 */
public class SingleP extends javax.swing.JFrame {

    ArrayList<Node> nodes;
    Node base_root;
    /**
     * Creates new form SingleP
     */
    public SingleP() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SingleP.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
